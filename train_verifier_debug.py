...
def main():
    ...
    os.environ['WANDB_NAME'] = f"{generator_id}-{experimentID}"
    ...
    args = [
        ...
        "--dedup", "True",
        "--per_problem_sampling_solution", str(n_solution),
        "--loss_level", "token",
        "--loss_on_llm", "True",
        "--num_train_epoches", "1",
        "--eval_steps", "1000",
    ...
    model_args, data_args, training_args, output_args = parser.parse_args_into_dataclasses(args)
