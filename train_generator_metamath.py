...
def main():
    ...
    if data_args.dataset == 'gsm8k':
        ...
        from utils.metamath.datasets import make_finetuning_generator_data_module
    ...
    # for training generator we use only train_dataloder, val_dataloader is None.
    ...
    os.environ['WANDB_PROJECT'] = 'MetaMath-Generator-Finetune'
    os.environ['WANDB_NAME'] = "opt-125m-generator"
